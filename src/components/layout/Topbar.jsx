  ...
  return (
    <header className="topbar-container bg-cream/80 backdrop-blur-xl border-b border-gold/10 px-10 h-20 flex items-center justify-between sticky top-0 z-[60]">
      <div className="topbar-left flex items-center gap-8">
        ...
        <h1 className="page-title font-display text-2xl text-black-deep italic">
          {currentTitle}
        </h1>
      </div>
      ...
      <div className="topbar-right flex items-center gap-6">
        ...
        {/* ── Profile Dropdown ── */}
        <div
          className="profile-btn flex items-center gap-4 p-2 pl-2 pr-4 rounded-full border border-gold/10 hover:bg-gold/5 transition-all cursor-pointer relative"
        ...
        >
          ...
          <div
            className={`dropdown-menu absolute top-full right-0 mt-4 bg-cream/95 backdrop-blur-xl border border-gold/10 rounded-3xl shadow-luxe p-3 min-w-[220px] transition-all transform origin-top-right ${

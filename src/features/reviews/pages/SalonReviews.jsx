                                 ...
                                 <div className="md:hidden flex flex-col gap-4">
                                     ...
                                     <div className="flex gap-2">
                                         <button
                                             ...
                                             className="flex-[2] py-3.5 bg-black-deep text-gold rounded-xl font-bold uppercase text-[10px] tracking-[0.2em] hover:brightness-125 transition-all shadow-md active:scale-[0.98]"
                                         >
                                             View Full Feedback
                                         </button>
                                         <button
                                             onClick={() => handleDelete(review.id)}
                                             className="flex-1 py-3.5 bg-red-50 text-red-600 border border-red-100 rounded-xl font-bold uppercase text-[10px] tracking-widest flex items-center justify-center shadow-md active:scale-[0.98]"
                                         >

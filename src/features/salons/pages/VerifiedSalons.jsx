    ...
    <div className="w-full font-jost font-light min-h-[calc(100vh-80px)]">
      <div className="container mx-auto pb-12 pt-4 bg-transparent max-w-5xl">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-4 px-2">
          <div>
            <h1 className="font-display text-4xl italic text-black-deep mb-2">Verified Salons</h1>
            <p className="text-secondary text-base">All approved and active salons on the platform.</p>
          </div>
          <div className="text-right bg-white px-6 py-3 rounded-2xl border border-gold/10 shadow-sm flex items-center gap-4 hidden md:flex">
            <div className="text-xs text-secondary font-bold uppercase tracking-widest text-left">Total<br />Verified</div>
            <div className="text-3xl font-display font-bold text-green-600">{totalElements}</div>
          </div>
        </div>

      ...
      <div className="space-y-6 flex-1">
        ...
        <div className="grid grid-cols-1 gap-4">
          <div className="p-4 rounded-2xl bg-indigo-50/30 border border-indigo-100/50">
            ...
            <div className="flex justify-between items-end">
              <div>
                ...
                <p className="text-[10px] text-slate-400 font-medium">Avg: ₹354/booking</p>
              </div>
              <p className="text-[10px] text-slate-400 font-medium">Yesterday: ₹3,100</p>
            </div>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-slate-50 border border-slate-100">
            ...
            <div className="flex justify-between items-end">
              <div>
                <p className="text-xl font-bold text-slate-900">₹1,45,200</p>
                <p className="text-[10px] text-slate-400 font-medium">AOV: ₹1,120</p>
              </div>
              <p className="text-[10px] text-slate-400 font-medium">Target: ₹1.6L</p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              <div className="flex justify-between text-xs">
                ...
                <span className="font-bold text-slate-900">₹1,18,000 (82%)</span>
              </div>
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-xs">
                ...
                <span className="font-bold text-slate-900">₹27,200 (18%)</span>
              </div>
              <div className="w-full h-1.5 bg-slate-100 rounded-full overflow-hidden">

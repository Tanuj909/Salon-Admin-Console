    ...
    <div className="auth-page">
      ...
      <div className="auth-card">
        <div className="auth-header">
          <h1 className="auth-title">Dashboard Analytics</h1>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="auth-form-group">
            <div className="flex justify-between items-center mb-2">
              ...
              <button type="button" className="text-[11px] font-bold text-[#4a7cf7] hover:underline">Forgot?</button>
            </div>
          ...
          <div className="flex items-center gap-2 mb-8 select-none cursor-pointer group">
            <input type="checkbox" id="remember" className="w-4 h-4 rounded border-slate-200 accent-[#4a7cf7]" />
            <label htmlFor="remember" className="text-xs text-slate-500 font-medium group-hover:text-slate-700 cursor-pointer">Stay signed in for 30 days</label>
          </div>

          <button
            type="submit"
            disabled={loading}
            className="auth-btn flex items-center justify-center gap-3"
          >
            {loading ? (
